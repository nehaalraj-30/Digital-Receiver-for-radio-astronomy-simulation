...
plt.xlim(0,2000e6)
plt.title("power_spectrum_mag for cross correlation and accumalation of FFT Output Signal")
plt.xlabel("freq")
...
plt.xlim(0,2000e6)
plt.title("power_spectrum_phase for cross correlation and accumalation of FFT Output Signal")
plt.xlabel("freq")
plt.ylabel("cross_corr_phase_radians")
plt.grid(True)
plt.show()  
...
plt.xlim(0,2000e6)
plt.title("power_spectrum_1 for self correlation and accumalation of FFT Output Signal")
plt.xlabel("freq")
...
plt.xlim(0,2000e6)
plt.title("power_spectrum_2 for self correlation and accumalation of FFT Output Signal")
plt.xlabel("freq")
